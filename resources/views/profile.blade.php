...
<hr />
<form method="POST" enctype="multipart/form-data" action="{{ route('update-profile', ['id' =>  auth()->user()->id]) }}" class="max-w-md mx-auto bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
    @csrf
    @method('PUT')
    <div class="mb-4">
