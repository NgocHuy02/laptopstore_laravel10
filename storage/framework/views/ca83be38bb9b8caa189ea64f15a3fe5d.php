                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" method="post" action="<?php echo e(route('login.action')); ?>">
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Don’t have an account yet? <a href="<?php echo e(route('register')); ?>" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</a>
                        </p>
                    </form>
                </div>
            </div>
...
</html><?php /**PATH E:\xampp\htdocs\laptopstore-app\resources\views/auth/login.blade.php ENDPATH**/ ?>