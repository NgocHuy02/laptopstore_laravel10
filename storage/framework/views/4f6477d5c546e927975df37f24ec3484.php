        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form action="<?php echo e(route('register.save')); ?>" method="POST" class="space-y-4 md:space-y-6">
                        <?php echo csrf_field(); ?>
                        <div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Already have an account? <a href="<?php echo e(route('login')); ?>" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Login here</a>
                        </p>
                    </form>
                </div>
            </div>
...
</html><?php /**PATH E:\xampp\htdocs\laptopstore-app\resources\views/auth/register.blade.php ENDPATH**/ ?>